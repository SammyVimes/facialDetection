...
String face_cascade_name = "/home/dsv/development/opcv/haar/haarcascade_frontalface_alt.xml";
String eyes_cascade_name = "/home/dsv/development/opcv/haar/haarcascade_eye.xml";
String profile_face_cascade_name = "/home/dsv/development/opcv/haar/haarcascade_profileface.xml";
String mouth_cascade_name = "/home/dsv/development/opcv/haar/mouth.xml";
String nose_cascade_name = "/home/dsv/development/opcv/haar/nose.xml";
...
void writeConfigFile(vector<float> left, vector<float> mid, vector<float> right, vector<float> down, vector<float> up, float headwidth) {
	ofstream myFile;
	myFile.open("/home/dsv/configuration.txt");
